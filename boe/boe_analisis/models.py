...
class Documento(models.Model):
    ...
    fecha_disposicion = models.DateField(null=True,default='')
    fecha_publicacion = models.DateField(null=True,default='')
    fecha_vigencia = models.DateField(null=True, default='')
    fecha_derogacion = models.DateField(null=True, default='')
