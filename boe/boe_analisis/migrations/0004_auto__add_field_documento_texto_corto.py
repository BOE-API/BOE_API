...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documento.texto_corto'
        db.add_column(u'boe_analisis_documento', 'texto_corto',
                      self.gf('django.db.models.fields.CharField')(max_length=65535, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documento.texto_corto'
        db.delete_column(u'boe_analisis_documento', 'texto_corto')
    ...
    models = {
        ...
        u'boe_analisis.documento': {
            ...
            'texto_corto': ('django.db.models.fields.CharField', [], {'max_length': '65535', 'null': 'True'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '1500', 'null': 'True'}),
