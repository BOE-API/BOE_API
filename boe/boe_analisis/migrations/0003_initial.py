...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'boe_analisis_diario', (
            ...
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
        ))
        ...
        db.create_table(u'boe_analisis_partido', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'boe_analisis', ['Partido'])

        # Adding model 'Legislatura'
        db.create_table(u'boe_analisis_legislatura', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inicio', self.gf('django.db.models.fields.DateField')()),
            ('final', self.gf('django.db.models.fields.DateField')()),
            ('partido', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boe_analisis.Partido'])),
        ))
        db.send_create_signal(u'boe_analisis', ['Legislatura'])

        # Adding model 'Documento'
        db.create_table(u'boe_analisis_documento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identificador', self.gf('django.db.models.fields.CharField')(max_length=25, db_index=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(default='', max_length=1500, null=True, db_index=True)),
            ...
            ('seccion', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('subseccion', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ...
            ('numero_oficial', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('fecha_disposicion', self.gf('django.db.models.fields.DateField')(null=True)),
            ('fecha_publicacion', self.gf('django.db.models.fields.DateField')(null=True, db_index=True)),
            ...
            ('letra_imagen', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True)),
            ...
            ('suplemento_letra_imagen', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True)),
            ('suplemento_pagina_inicial', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True)),
            ('suplemento_pagina_final', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True)),
            ('estatus_legislativo', self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True)),
            ...
            ('legislatura', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['boe_analisis.Legislatura'], null=True)),
            ('url_epub', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('url_xml', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, db_index=True)),
            ...
            ('texto', self.gf('django.db.models.fields.TextField')(default='', null=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'boe_analisis_partido')

        # Deleting model 'Legislatura'
        db.delete_table(u'boe_analisis_legislatura')
    ...
    models = {
        ...
        u'boe_analisis.documento': {
            ...
            'identificador': ('django.db.models.fields.CharField', [], {'max_length': '25', 'db_index': 'True'}),
