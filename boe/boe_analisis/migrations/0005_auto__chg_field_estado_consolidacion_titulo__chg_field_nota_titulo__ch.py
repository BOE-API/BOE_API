...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'boe_analisis_estado_consolidacion', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Nota.titulo'
        db.alter_column(u'boe_analisis_nota', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Alerta.titulo'
        db.alter_column(u'boe_analisis_alerta', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Palabra.titulo'
        db.alter_column(u'boe_analisis_palabra', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Rango.titulo'
        db.alter_column(u'boe_analisis_rango', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Materia.titulo'
        db.alter_column(u'boe_analisis_materia', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Origen_legislativo.titulo'
        db.alter_column(u'boe_analisis_origen_legislativo', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Departamento.titulo'
        db.alter_column(u'boe_analisis_departamento', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))
    ...
    models = {
        u'boe_analisis.alerta': {
            ...
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '800', 'null': 'True'})
        },
