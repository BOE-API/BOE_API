...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Documento.titulo'
        db.alter_column(u'boe_analisis_documento', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=1500, null=True))

    def backwards(self, orm):

        # Changing field 'Documento.titulo'
        db.alter_column(u'boe_analisis_documento', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
